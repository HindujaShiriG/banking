...
function DepositDetails() {
  ...
  const transactionData = {
    ...
    fetch(`https://firestore.googleapis.com/v1/projects/banking-system-3c21a/databases/(default)/documents/Account`)
      .then(response => {
        if (!response.ok) {
      ...
      .then(data => {
        ...
        return fetch(`https://firestore.googleapis.com/v1/projects/banking-system-3c21a/databases/(default)/documents/Account/${docId}`, {
          method: 'PATCH',
          headers: {
